...
<div class="container-fluid  p-5 pm-md-0 ">
    <div class="row  justify-content-center">
        ...
        <div class="col-md-4 col-6 d-flex justify-content-center bg-light rounded">
            <h3 class="text-nowrap">{{count($articles)}} article to review</h3>
        </div>
    </div>
    <div class="row  justify-content-center vh-75  align-items-center ">
        ...
        <div class="col-md-3 col-12  bg-white rounded  revisor-card  p-3 my-2 my-lg-0">
            ...
            <div class="col-12 col-md-4   rounded d-flex  justify-content-center align-items-center rounded  my-2 my-lg-0">
                    <div id="carouselExampleControls" class="carousel slide  " data-bs-ride="carousel">
                        <div class="carousel-inner test bg-primary">
                            @foreach ($article->images as $image)
