<footer class="container-fluid">
    <div class="row mx-5">
        ...
        <div class="col-12 col-md-3 d-md-block d-none z-5">
            <div class="lead fs-6">
        ...
        <!-- UNDER FOOTER -->
        <div class="col-12 col-md-12 borderFooterTop mt-5 z-5 opacity-100">
            ...
            <div class="text-center lead fs-6 my-5">
                <p class="text-light">Copyright 2023 by CodeArtisans, All rights Reserved.</p>
            </div>
        </div>
    </div>
</footer>
