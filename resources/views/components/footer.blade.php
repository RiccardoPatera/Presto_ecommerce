    ...
    <div class="row mx-5">
        <div class="col-12 col-md-3">
            ...
            <div class="mt-4 lead fs-6">
                ...
                <li class="mt- mb-2">lorem@email.com</li>
                <li>010-555-0028</li>
            </div>
        </div>
        <div class="col-12 col-md-3">
            <div class="lead fs-6">
                <h4 class="fs-3 title-footer fw-semibold mt-4">Shopping & Categories</h4>
                <a class="text-decoration-none text-black" href="">
                    <li class="mt-4">Category 1</li>
                </a>
                <a class="text-decoration-none text-black" href="">
                    <li class="my-2">Category 2</li>
                </a>
                <a class="text-decoration-none text-black" href="">
                    <li>Category 3</li>
                </a>
        ...
        <div class="col-12 col-md-3">
            <div class="lead fs-6">
                <h4 class="fs-3 title-footer fw-semibold mt-4">Useful Links</h4>
                <a class="text-decoration-none text-black" href="">
        ...
        <div class="col-12 col-md-3">
            <div class="lead fs-6">
                <h4 class="fs-3 title-footer fw-semibold mt-4">Help & Information</h4>
                <a class="text-decoration-none text-black" href="">
        ...
        <div class="col-12 col-md-12 borderFooterTop mt-5">
            <div class="d-flex justify-content-around text-center my-5">
                ...
                <a href=""><i class="fa-brands icona-footer fa-linkedin"></i></a>
                <a href=""><i class="fa-brands icona-footer fa-instagram"></i></a>
            </div>
