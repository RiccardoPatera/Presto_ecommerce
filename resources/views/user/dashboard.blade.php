    ...
    <div class="container-fluid py-5">
        <div class="row d-flex justify-content-between">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 my-5 vh-50">
                    <div class="row justify-content-center">
                        <div class="col-6 mb-3 me-3">
                            <p class="text-start text-light fs-3">User info</p>
                        </div>
                        <div class="col-9 my-3">
                            <div class="card card-userInfo p-5">
                ...
                <div class="col-12 bg-success col-md-6 mt-5 vh-50">


                    <div class="row">
                        <div class="col-12">
                            <h2 class="text-white text-center mb-5"> User Articles</h2>
                        </div>
                                                ...
                                                <a href="{{ route('show_article', compact('article')) }}">
                                                    ...
                                                    @elseif($article->is_accepted == 1)
                                                        ...
                                                        <div class="fs-5 text-light position-absolute bottom-0 end-0 translate-middle-x">
                                                            ...
                                                            <a class="btn bg-dark p-0" href=""><i class="fa-solid fa-trash textDelete  bg-opacity-75 rounded-top p-2"></i></a>
                                                        </div>
